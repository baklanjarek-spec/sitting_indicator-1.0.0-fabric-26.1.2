...
public class SittingIndicatorMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(SittingIndicatorMod.class);
	public static final String MODID = "sitting_indicator";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing SittingIndicatorMod");
		tick();
